...
import com.cluster.taxiuser.ui.activity.add_card.AddCardActivity;
...
import static com.cluster.taxiuser.ui.fragment.invoice.InvoiceFragment.isInvoiceCashToCard;
...
/*
    ...
    @OnClick({R.id.add_card, R.id.cash, R.id.paypal})
