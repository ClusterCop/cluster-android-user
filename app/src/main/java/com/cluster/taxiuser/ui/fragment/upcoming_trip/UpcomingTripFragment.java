...
import com.cluster.taxiuser.ui.activity.upcoming_trip_detail.UpcomingTripDetailActivity;
...
/*
    ...
    private class TripAdapter extends RecyclerView.Adapter<TripAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            if (provider != null)
                Glide.with(activity()).load(provider.getAvatar()).apply(RequestOptions.placeholderOf(R.drawable.ic_user_placeholder).dontAnimate().error(R.drawable.ic_user_placeholder)).into(holder.avatar);
