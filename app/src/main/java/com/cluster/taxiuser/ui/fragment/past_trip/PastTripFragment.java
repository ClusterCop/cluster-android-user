package com.cluster.taxiuser.ui.fragment.past_trip;
...
import com.cluster.taxiuser.ui.activity.past_trip_detail.PastTripDetailActivity;
...
public class PastTripFragment extends BaseFragment implements PastTripIView {
    ...
    private class TripAdapter extends RecyclerView.Adapter<TripAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            if (payment != null) {
                String s = numberFormat.format(payment.getTotal());
