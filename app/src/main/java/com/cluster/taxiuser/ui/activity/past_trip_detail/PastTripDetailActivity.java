...
import com.cluster.taxiuser.data.network.model.Rating;
import com.cluster.taxiuser.ui.fragment.InvoiceDialogFragment;
...
public class PastTripDetailActivity extends BaseActivity implements PastTripDetailsIView {
    ...
    public void onSuccess(List<Datum> pastTripDetails) {
        ...
        if(datum != null) {
            ...
            if (payment != null) payable.setText(SharedHelper.getKey(this, "currency") + " " +
